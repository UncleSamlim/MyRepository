...
<head>
	...
	<body>
		...
		<div class="header">
			<a href="UserServlet?action=InitIndex"><img src="img/login/logo.png"></a>
		</div>
		<div class="wow">
			<div class="inner">
				<div class="adv_link">
				...
				<div class="login">
					...
					<div class="bd">
						...
						<form action="LoginServlet" method="post">
							<div class="username">
								...
								<input type="text" name="uesrname" id="" value="" placeholder="会员名/邮箱/手机号" />
					...
					<div class="fd">
						<a href="">忘记密码</a><a href="">忘记会员名</a><a href="register.jsp">免费注册</a>
					</div>
				</div>
			</div>
		</div>
